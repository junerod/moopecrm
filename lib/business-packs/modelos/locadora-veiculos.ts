...
export const PACK_LOCADORA_VEICULOS: BusinessPackDefinition = {
  ...
  capabilities: [
    { key: "clientes", label: "Clientes", tool_id: "moope_lookup_locatario", read: true, write: false },
    { key: "locacoes", label: "Locações", tool_id: "moope_get_retrato", read: true, write: false },
    { key: "veiculos", label: "Veículos", tool_id: "moope_listar_oferta", read: true, write: false },
    { key: "disponibilidade", label: "Disponibilidade", tool_id: "moope_listar_oferta", read: true, write: false },
    { key: "financeiro", label: "Financeiro", tool_id: "moope_get_retrato", read: true, write: false },
    { key: "manutencao", label: "Manutenção", tool_id: null, read: false, write: false },
    { key: "multas", label: "Multas", tool_id: null, read: false, write: false },
    { key: "sinistros", label: "Sinistros", tool_id: null, read: false, write: false },
  ],
