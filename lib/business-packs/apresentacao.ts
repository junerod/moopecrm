...
const TEXTO_CLINICA_MEDICA: Record<string, { oQueFaz: string; papel: string }> = {
  recepcao: {
    oQueFaz: "Recebe, identifica se já é paciente e encaminha",
    papel: "Recepção e triagem",
  },
  comercial: {
    oQueFaz: "Qualifica especialidade e ajuda a agendar",
    papel: "Novos pacientes e agenda",
  },
  atendimento: {
    oQueFaz: "Orienta o lado administrativo da consulta",
    papel: "Horários, encaminhamento e dúvidas práticas",
  },
  documentos: {
    oQueFaz: "Pede documentos e confirma o que falta",
    papel: "Checklist documental",
  },
  financeiro: {
    oQueFaz: "Informa convênio e valor só com tabela da clínica",
    papel: "Convênio, particular e vencimentos",
  },
  relacionamento: {
    oQueFaz: "Lembrete de retorno e reativação",
    papel: "Follow-up e satisfação",
  },
};

const TEXTO_CLINICA_ODONTO: Record<string, { oQueFaz: string; papel: string }> = {
  recepcao: {
    oQueFaz: "Recebe, identifica paciente ou novo contato e encaminha",
    papel: "Recepção e triagem",
  },
  comercial: {
    oQueFaz: "Agenda avaliação e acompanha orçamento cadastrado",
    papel: "Avaliação e orçamento",
  },
  atendimento: {
    oQueFaz: "Orienta o lado administrativo do tratamento",
    papel: "Horários, encaminhamento e dúvidas práticas",
  },
  documentos: {
    oQueFaz: "Pede o checklist da clínica. Não interpreta exame",
    papel: "Documentos e preparo",
  },
  financeiro: {
    oQueFaz: "Fala de parcela e convênio só com orçamento oficial",
    papel: "Orçamento e financeiro",
  },
  relacionamento: {
    oQueFaz: "Lembrete de retorno, manutenção e satisfação",
    papel: "Follow-up e relacionamento",
  },
};

const TEXTO_SAAS: Record<string, { oQueFaz: string; papel: string }> = {
  recepcao: {
    oQueFaz: "Recebe, entende o tipo de empresa e encaminha",
    papel: "Recepção comercial",
  },
  comercial: {
    oQueFaz: "Qualifica, agenda demo e acompanha piloto",
    papel: "Vendas e demo",
  },
  atendimento: {
    oQueFaz: "Ajuda o cliente novo a começar, sem inventar o produto",
    papel: "Onboarding",
  },
  documentos: {
    oQueFaz: "Pede dados e confirma envio da proposta quando houver modelo",
    papel: "Proposta e contrato",
  },
  financeiro: {
    oQueFaz: "Fala de plano e vencimento só com fonte",
    papel: "Financeiro",
  },
  relacionamento: {
    oQueFaz: "Follow-up, renovação e satisfação",
...
const TEXTO_COMERCIAL: Record<string, { oQueFaz: string; papel: string }> = {
  recepcao: {
    oQueFaz: "Recebe e entende se é venda nova ou cliente",
    papel: "Recepção",
  },
  comercial: {
    oQueFaz: "Qualifica, monta proposta e faz follow-up",
    papel: "Vendas",
  },
  atendimento: {
    oQueFaz: "Pós-venda e dúvidas administrativas",
    papel: "Atendimento ao cliente",
  },
  documentos: {
    oQueFaz: "Pede dados do pedido e confirma recebimento",
    papel: "Pedido e documentos",
  },
  financeiro: {
    oQueFaz: "Cobrança e vencimento só com fonte",
    papel: "Financeiro",
  },
  relacionamento: {
    oQueFaz: "Follow-up, reativação e satisfação",
