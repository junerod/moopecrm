...
interface KanbanCardProps {
  ...
  /**
   * Lista fora do DragDropContext (etapa em tela cheia). Sem isto o
   * `@hello-pangea/dnd` exige Draggable dentro de Droppable e a tela quebra.
   */
  disableDrag?: boolean;
  /** Outros funis da org — menu «Enviar para funil…». */
  ...
  const body = (dragging: boolean) => (
    <div
      ...
      className={cn(
        ...
        dragging && "opacity-90 shadow-[var(--shadow-lg)] ring-2 ring-[var(--moope-primary)]",
    ...
    >
      ...
      <div className="flex items-start justify-between gap-2">
        ...
        <div className="flex shrink-0 items-center gap-1.5">
          ...
          <KanbanCardActions lead={lead} pipelineId={pipelineId} stages={stages} funis={funis} />
        </div>
      </div>
      ...
      <LinhaProximaAcao status={lead.status} acao={card.proximaAcao} />
